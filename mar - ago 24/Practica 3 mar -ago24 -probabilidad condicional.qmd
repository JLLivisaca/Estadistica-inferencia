...
Suponga que se selecciona un individuo al azar de la pobla- ción y que los eventos se definen como A  {tipo A seleccio- nado}, B  {tipo B seleccionado} y C  {grupo étnico 3 seleccionado}.

1.  Calcule P(A), P(C ) y P(A  C).
